  ...
  columns: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          field: "annualStatement.m2",
          title: "二月",
          width: 140,
          formatter: formatAmount,
        },
        {
          field: "annualStatement.m3",
          title: "三月",
          width: 140,
          formatter: formatAmount,
        },
        {
          field: "annualStatement.m4",
          title: "四月",
          width: 140,
          formatter: formatAmount,
        },
        {
          field: "annualStatement.m5",
          title: "五月",
          width: 140,
          formatter: formatAmount,
        },
        {
          field: "annualStatement.m6",
          title: "六月",
          width: 140,
          formatter: formatAmount,
        },
        {
          field: "annualStatement.m7",
          title: "七月",
          width: 140,
          formatter: formatAmount,
        },
        {
          field: "annualStatement.m8",
          title: "八月",
          width: 140,
          formatter: formatAmount,
        },
        {
          field: "annualStatement.m9",
          title: "九月",
          width: 140,
          formatter: formatAmount,
        },
        {
          field: "annualStatement.m10",
          title: "十月",
          width: 140,
          formatter: formatAmount,
        },
        {
          field: "annualStatement.m11",
          title: "十一月",
          width: 140,
          formatter: formatAmount,
        },
        {
          field: "annualStatement.m12",
          title: "十二月",
          width: 140,
          formatter: formatAmount,
        },
...
const arList = XEUtils.shuffle(
  XEUtils.range(1, 21).map(
    (num) => `https://vxeui.com/resource/avatarImg/avatar${num}.jpeg`
  )
);
const neList = XEUtils.shuffle([
  "张三",
  "李四",
  "王五",
  "小徐",
...
const elList = XEUtils.range(1, 60).map(
  (num) =>
    `${XEUtils.sample(
...
const fgList = XEUtils.shuffle(
  XEUtils.range(1, 60).map((num) => num % 2 === 0)
);
const cacheList = [];
